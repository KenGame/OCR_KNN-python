#"""Programa realizado por: Julia Gabriela Chico Pérez y Francisco Javier Reyes Beristain"""
#Librerias
...
def menu():
    ...
    while(repetir == 1):#condicion del while
        print("\nMenu \n1- Generar el archivo .csv\n2- Aplicar el OCR con KNN")#impresion de opciones
...
def knn():
    ...
    r = "prueba/"+r_imagen#la ruta la concatenamos con la carpeta por defecto que se llama test
